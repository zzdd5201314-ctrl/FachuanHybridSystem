...
class CaseDetailsQueryService:
    ...
    def get_case_with_details_internal(self, case_id: int) -> dict[str, Any] | None:
            ...
            assignments.append(
                {
                    ...
                    "law_firm_name": (
                        ...
                        if (lawyer and getattr(lawyer, "law_firm", None) and lawyer.law_firm)
                        else None
                    ),
                }
            )
        ...
        return {
            ...
            "preservation_amount": (float(case.preservation_amount) if case.preservation_amount is not None else None),
