                ...
                (
                    str(_("短信信息")),
                    {
                        ...
                        "description": (
                            ...
                            "<span>人民法院在线服务网 <code>zxfw</code></span>"
                            "<span>睿法智达 <code>gdems</code></span>"
                            "<span>集约送达 <code>jysd</code></span>"
                            "<span>湖北电子送达 <code>hbfy</code></span>"
                            "<span>司法送达网 <code>sfdw</code></span>"
                            "</div>"
                            "</div>"
                        ),
                    },
