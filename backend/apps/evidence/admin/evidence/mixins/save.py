...
from apps.evidence.models import LIST_TYPE_PREVIOUS, EvidenceItem, EvidenceList, ListType
...
class EvidenceListAdminSaveMixin(EvidenceListAdminServiceMixin):
    ...
    def _count_pdf_pages(items: list[Any], request: Any, messages: Any) -> None:
        ...
        for obj in items:
            try:
                from apps.evidence.services.infrastructure.pdf_utils import get_pdf_page_count_with_error
