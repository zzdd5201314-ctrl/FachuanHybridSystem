...
import type { LprCalculateRequest, LprCalculateResponse, PrincipalChange, CalculationPeriod } from '../api'
...
const YEAR_DAYS_OPTIONS = [
  { value: 360, label: '360天/年' },
  { value: 365, label: '365天/年' },
  { value: 0, label: '实际天数' },
] as const

const DATE_INCLUSION_OPTIONS = [
...
const CUSTOM_RATE_UNIT_OPTIONS = [
...
function getRateInfo(form: HistoryItem['form']): string {
...
function groupByPrincipal(periods: CalculationPeriod[]): PrincipalGroup[] {
...
function formatRateDisplay(rate: string, rateUnit: string | null, rateMode: string): string {
